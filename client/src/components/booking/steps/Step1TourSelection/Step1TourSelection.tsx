        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {trip.accommodations?.map((accommodation: any) => (
            <Card
              ...
              className={`cursor-pointer transition-all ${selectedAccommodation === accommodation._id ? "ring-2 ring-teal-600 bg-teal-50" : "hover:shadow-md"
                }`}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {trip.vehicles?.map((vehicle: any) => (
            <Card
              key={vehicle._id}
              className={`cursor-pointer transition-all ${selectedVehicle === vehicle._id ? "ring-2 ring-teal-600 bg-teal-50" : "hover:shadow-md"
                }`}
